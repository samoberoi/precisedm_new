...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    excerpt:
      "Obesity changes insulin requirements in ways simple formulas rarely capture. A practical look at diabetes obesity insulin dosing challenges and the structured assessment that supports safer decisions.",
